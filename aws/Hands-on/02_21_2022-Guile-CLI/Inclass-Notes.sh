...
aws ec2 run-instances \
   ...
   --key-name KEY_NAME # put your key name

   aws ec2 describe-instances --filters "Name = key-name, Values = KEY_NAME_HERE" # put your key name
...
'Parameters[0].[Value]' --output text) --count 1 --instance-type t2.micro --key-name newpair
